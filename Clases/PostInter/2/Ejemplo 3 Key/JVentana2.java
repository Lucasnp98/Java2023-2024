...
public class JVentana2 extends JFrame
{
	...
	public JVentana2()
	{
        ...
        //  HashMap<Character, String> movimientos = new HashMap<>();
        //  movimientos.put('a', "Mover derecha");
        //  movimientos.put('s',"Mover izquierda");
        //  movimientos.put('d',"Mover arriba");
        //  movimientos.put('f',"mover abajo");
        txtNombre.addKeyListener(new KeyAdapter()
        	{
                ...
                public void keyTyped(KeyEvent e)   
                {
                    ...
                    // if (movimientos.containsKey(e.getKeyChar()))
                    // {
                    //     System.out.println(movimientos.get(e.getKeyChar()));
                    // }
